                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Электронная почта пользователя</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Пользовательская фотография </label>
                                    <div class="col-sm-10">
                                ...
                                <!-- end row -->
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Обновить профиль">
                            </form>
